...
public class CustomAdapterCompleted extends RecyclerView.Adapter {
    ...
    CustomAdapterCompleted(DailyTaskTracker mainActivity, LinkSequence<Tree<KanbanTasks>.Node> tasksList){
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        txTitle.setText(dataNode.kanbanTask.getTitle());
        TextView txContent = holder.itemView.findViewById(R.id.completedContent);
        txContent.setText(dataNode.kanbanTask.getContent());
        TextView txDuration = holder.itemView.findViewById(R.id.textViewTime);
        String durationText = dataNode.kanbanTask.getDuration() + " Mins";
    ...
    public void sendPosition(int position, String fromStatus, String toStatus){
        mainActivity.updateLists(position, fromStatus, toStatus);
    }
